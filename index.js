            ...
            _API.readConfigServers("API", _TS).then(function () {
                    ...
                    switch (window.location.host) {
                        case "localhost:4441": //Gestión externa de deuda - dev daniel
                            _API.setBranch("Credipaz.GestionExternaDeuda", "Acceso a la gestión externa de deuda", true, "./img/credipaz.png", 1);
                            break;
                        case "localhost:4442": //Cesiones - dev daniel
                            _API.setBranch("Credipaz.Cesiones", "Acceso a información de cesiones", true, "./img/credipaz.png", 1);
                            break;
                    ...
                    if (!_API.loginRequired) {
                        ...
                        _API.authenticate().then(function () { _API.onShowLoginModal(); });
                    }
            });
        });
    });
